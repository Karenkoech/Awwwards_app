...
def Upload_Project(request):
    ...
    return render(request,"myapp/add-project.html",context)
...
def RateProject(request,pk):
    ...
    return render(request,"myapp/rate-project.html",context)
...
def User_Profile(request):
    ...
    return render(request,"myapp/profile-details.html",context)
...
def Dev_center(request):
    ...
    return render(request,"myapp/devcenter.html",context)
